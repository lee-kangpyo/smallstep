...
import { LoadingView } from '../screens/GoalTemplateSelectionScreen/components/LoadingView';
import { ErrorView } from '../screens/GoalTemplateSelectionScreen/components/ErrorView';
import { TemplateListView } from '../screens/GoalTemplateSelectionScreen/components/TemplateListView';
import { TemplateDetailView } from '../screens/GoalTemplateSelectionScreen/components/TemplateDetailView';

// Force cache refresh
export default function GoalTemplateSelectionScreen() {
  ...
  const handleStartWithTemplate = () => {
    if (selectedTemplate && templateDetail) {
      ...
      router.push({
        pathname: '/calendar-customization',
        params: {
